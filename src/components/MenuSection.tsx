...
import { menuItems, categories, type MenuItem } from "@/data/menuItems";
...
const MenuSection = () => {
  ...
  // Listen for category changes from notebook menu
  useEffect(() => {
    const handleCategoryChangeEvent = (event: CustomEvent) => {
    ...
    window.addEventListener("categoryChange" as any, handleCategoryChangeEvent);
    return () => {
      window.removeEventListener("categoryChange" as any, handleCategoryChangeEvent);
    };
